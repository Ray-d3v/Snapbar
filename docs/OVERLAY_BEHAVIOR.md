...
- The idle surface is a centered 92 × 28 logical-pixel pill. It expands horizontally to a 272 × 34 logical-pixel control strip after the configured hover delay.
